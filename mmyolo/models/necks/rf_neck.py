...
class RFYOLONeck(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        self.re_up_layers = nn.ModuleList()

        for idx in range(1,len(in_channels)):
            self.re_up_layers.append(self.reup_layer(idx))
        ...
        for idx in range(1,len(in_channels) - 1):
